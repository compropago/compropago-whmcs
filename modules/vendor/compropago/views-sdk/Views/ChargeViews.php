...
namespace CompropagoViews;


class ChargeView
{
    /**
     * regresa el codigo css de las vistas
     *
     * @return mixed
     */
    public static function getSourceStyle()
    {
        $source = file_get_contents(__DIR__."/Assests/css/cpstyle.css");
        return $source;
    }
    ...
    public static function getView($view = null, $dataView = null, $getMethod = null, $ext = null)
    {
        ...
        $file = "$view.$ext";
        $full_dir = __DIR__ . "/Files/$ext/$file";
